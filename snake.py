...
window.timeout(10)  # Set the timeout for the window to 10 milliseconds
...
window.addch(food[0], food[1], "O")  # Draw the food on the window
...
while True:
    ...
    window.addch(snake[0][0], snake[0][1], "x")  # Draw the snake on the window
